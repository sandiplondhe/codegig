...
function mdnComaptDataProvider() {
  const apiMetadata = [];
  const normalizedBrowserCompatApis = [...Object.entries(_browserCompatData.default.api).map(([name, api]) => ({ ...api,
    name,
    kind: _types.APIKind.Web
  })), ...Object.entries(_browserCompatData.default.javascript.builtins).map(([name, api]) => ({ ...api,
    name,
